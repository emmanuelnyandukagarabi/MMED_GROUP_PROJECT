...
# Total number of days over 50 years.
times <- seq(0, 50 * 365, 5)
...
# Save the plot to a PDF file using ggsave
ggsave(filename = "SEIR_vaccination_rates_fin.pdf", plot = plot_results, device = "pdf", path = path)
